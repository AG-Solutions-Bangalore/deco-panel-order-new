...
export function QuotationReportPage() {
  ...
  return (
    <div className="flex flex-col gap-5 p-4 md:p-6 w-full max-w-7xl mx-auto pb-24 md:pb-6 animate-fade-in duration-300">
      <PageHeader
        title="Reports"
        subtitle="Manage quotation reports, export CSV data, or inspect detailed summaries."
      />
        ...
        <CardContent className="p-6">
          <form className="space-y-6" onSubmit={handleDownload}>
            ...
            <div className="flex flex-wrap items-center gap-3 pt-2">
              <Button
                type="submit"
                disabled={downloading || !ordersUserId}
